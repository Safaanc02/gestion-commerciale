            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-input rounded-lg focus:ring-2 focus:ring-brand focus:border-brand outline-none"
                  required
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    value={form.password}
                    onChange={handleChange}
                    className="w-full px-4 py-2.5 pr-10 border border-input rounded-lg focus:ring-2 focus:ring-brand focus:border-brand outline-none"
                    required
                  />
                  <button
                    type="button"
